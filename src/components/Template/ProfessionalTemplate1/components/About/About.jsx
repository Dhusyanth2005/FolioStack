    ...
    <section id="about" className={styles.section} ref={sectionRef}>
      <div className={styles.contentContainer}>
        <h2 className={styles.sectionHeading}>
          <User className={styles.headingIcon}/>About Me
        ...
        <div className={styles.aboutContainer}>
          <p className={styles.aboutText}>{data.bio}</p>
              ...
              <ul className={styles.aboutList}>
                {data.achievements.map((achievement, index) => (
                  <li key={index} className={styles.aboutListItem}>
                    ...
                    <span className={styles.achievementYear}>({achievement.year})</span> - {achievement.description}
                  </li>
                ))}
              </ul>
            </div>
