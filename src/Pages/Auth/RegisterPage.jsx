...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://backendportfolio-v4kd.onrender.com/api/auth/register', {
      ...
      const errorMessage = err.response?.data?.message || 
        (err.response?.data?.errors ? err.response.data.errors.map(e => e.msg).join(', ') : 'Registration failed');
    ...
    <div className={styles.authContainer}>
      ...
      <div className={styles.leftSection}>
        <div className={`${styles.leftContent} ${mounted ? styles.animate : ''}`}>
          ...
          <ul className={styles.featuresList}>
            <li>Professional templates for every industry</li>
            <li>Fully customizable designs</li>
            <li>Stunning project showcases</li>
      ...
      <div className={styles.rightSection}>
        <form className={styles.authForm} onSubmit={handleSubmit}>
          ...
          <div className={styles.socialLoginText}>Or sign up with</div>
